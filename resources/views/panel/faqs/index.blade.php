@extends('panel.layout.master' , ['title' => 'الأسئلة الشائعة'])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">الأسئلة الشائعة</h3>
            </div>
        </div>
    </div>
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        <a href="{{ route('panel.faqs.create') }}" class="btn btn-brand btn-elevate btn-icon-sm">
    ...
    <script>
        ...
        window.columns = [
            ...
            },
            {
                ...
                width: 100,
                template: function (data) {
                    var editUrl = "{{ url('panel/faqs/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/faqs/') }}/" + data.id;
                    return `
