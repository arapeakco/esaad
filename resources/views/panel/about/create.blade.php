                        ...
                        @foreach(locales() as $key=>$language)
                            ...
                            <div class="tab-pane {{$i==1?'active':''}}" id="kt_tabs_{{$i}}" role="tabpanel">
                                ...
                                <div class="form-group">
                                    <label>العنوان</label>
                                    <input class="form-control m-input" type="text" name="{{ 'about_title_'.$key }}"
                                           placeholder="العنوان" required value="{{ getSetting('about_title_' . $key) }}">

                                </div>
                                <div class="form-group">
                                    <label>المحتوى</label>
                                    <textarea class="summernote form-control" style="display:none!important;" id="kt_summernote_1"
                                              name="{{ 'about_content_'.$key }}" required placeholder="المحتوى">{{ getSetting('about_content_' . $key) }}</textarea>
                                </div>
                ...
                <div class="kt-portlet__body ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imgload" name="about_image" >
                    ...
                    <div class="img-responsive">
                        <div class="imageEditProfile">
                            <img src="{{ url('image/' . getSetting('about_image')) }}" alt="" id="imgshow" style="max-width: 100%">
                        </div>
                    </div>
