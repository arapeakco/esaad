        ...
        <div class="col-md-8">
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group">
                        <label>المهنة</label>
                        <input class="form-control m-input" type="text" name="specialization"
                               placeholder="المهنة" required value="{{ isset($item) ? $item->data['specialization'] : "" }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"
                                  name="short_description" required rows="5"
                ...
                <div class="kt-portlet__body ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="imgload" name="image" {{ isset($item) ? "" : "required" }} >
