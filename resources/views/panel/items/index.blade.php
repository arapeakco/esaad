@extends('panel.layout.master' , ['title' => 'قوائم الموقع'])
    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">قوائم الموقع</h3>
            </div>
        </div>
    </div>
...
@push('js')
    ...
    <script>
        ...
        window.data_url = '{{ route('panel.items.datatable') }}';
        ...
        window.columns = [
            ...
            },
            {
                ...
                template: function (data) {
                    var editUrl = "{{ url('panel/items/') }}/" + data.id + "/edit";
                    var deleteUrl = "{{ url('panel/items/') }}/" + data.id;
                    return `
